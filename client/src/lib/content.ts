...
export const salesReels: SalesReel[] = [
  { 
    ...
    comments: [
      ...
      { id: "c1-4", author: "Игорь С.", authorAvatar: avatar4, text: "Вау, такая простая схема работает!", likes: 53, timestamp: "3ч" },
      { id: "c1-5", author: "Ольга Н.", authorAvatar: avatar5, text: "Кто уже начал - отпишитесь в ответах 👇", likes: 78, timestamp: "6ч" },
      { id: "c1-6", author: "Михаил Р.", authorAvatar: avatar1, text: "Сохранил себе, буду изучать", likes: 31, timestamp: "8ч" },
      { id: "c1-7", author: "Светлана К.", text: "Реально крутой контент, подписалась!", likes: 47, timestamp: "12ч" }
    ]
  },
  { 
    id: "s2", 
