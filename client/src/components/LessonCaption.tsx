...
export default function LessonCaption({ lessonId, brief, full, author, authorAvatar }: LessonCaptionProps) {
  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 z-30 bg-gradient-to-t from-black via-black/80 via-black/60 via-black/40 via-black/20 to-transparent pt-32">
