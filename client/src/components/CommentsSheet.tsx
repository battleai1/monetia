      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed bottom-0 lg:bottom-[26px] left-0 right-0 lg:left-[var(--phone-left)] lg:right-auto lg:w-[402px] z-50 bg-[#262626] rounded-t-3xl max-h-[75vh] lg:max-h-[660px] flex flex-col pb-safe lg:pb-0"
